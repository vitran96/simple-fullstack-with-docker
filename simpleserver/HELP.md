...
* [GraalVM Native Image Support](https://docs.spring.io/spring-boot/docs/3.1.8/reference/html/native-image.html#native-image)
...
* [Configure AOT settings in Build Plugin](https://docs.spring.io/spring-boot/docs/3.1.8/maven-plugin/reference/htmlsingle/#aot)
...
```
$ docker run --rm -p 8080:8080 simpleweb:0.0.1-SNAPSHOT
```
